...
const advInfo = {
    ...
    15:{Desc:"[s]Burst Attack[/s] has a 10% chance to crit, dealing 50% additional DMG."},
    16:{Desc:"Increase the charge rate of [s]Parry Attack[/s] by 10%. <br><br> Battle Stats are also increased <br> [hp]"},
    17:{Desc:"Successful expeditions have a chance to reward [s]multiple items[/s]."},
    18:{Desc:"[s]Burst Attack's[/s] crit rate is increased to 20%."},
    19:{Desc:"[s]Evasion rate[/s] is further increased to 15%."},
    20:{Desc:"Once per battle, survive a [s]lethal blow[/s]. <br><br> Battle Stats are also increased <br> [hp]"},
}
...
const InventoryDefault = {
    ...
    // RMB TO UPDATE MAX CONSTANTS
        3001: {File:"adeptusTemptation",            Name:"Adeptus Temptation",            Lore:"Gourmet food that [s]temporarily[/s] boosts NpS by at least [s]500%[/s]. Also, boosts [s]morale[/s].",        Star:5,      Type:"Food"                         },
        3002: {File:"aBuoyantBreeze",               Name:"A Buoyant Breeze",              Lore:"Gourmet food that [s]temporarily[/s] boosts NpS by at least [s]500%[/s]. Also, boosts [s]morale[/s].",        Star:5,      Type:"Food"                              },
        3003: {File:"halvamazd",                    Name:"Halvamazd",                     Lore:"Gourmet food that [s]temporarily[/s] boosts NpS by at least [s]500%[/s]. Also, boosts [s]morale[/s].",        Star:5,      Type:"Food"                                          },
        3004: {File:"shimiChazuke",                 Name:"Shimi Chazuke",                 Lore:"Gourmet food that [s]temporarily[/s] boosts NpS by at least [s]500%[/s]. Also, boosts [s]morale[/s].",        Star:5,      Type:"Food"                                   },
        3005: {File:"slow-CookedBambooShootSoup",   Name:"Slow-Cooked Bamboo Shoot Soup", Lore:"Gourmet food that [s]temporarily[/s] boosts NpS by at least [s]500%[/s]. Also, boosts [s]morale[/s].",        Star:5,      Type:"Food"     },
        3006: {File:"goldenFriedChicken",           Name:"Golden Fried Chicken",          Lore:"Gourmet food that [s]temporarily[/s] boosts NpS by at least [s]500%[/s]. Also, boosts [s]morale[/s].",        Star:5,      Type:"Food"                      },
        
        3021: {File:"biryani",                      Name:"Biryani",                     Lore:"Exceptional food that [s]temporarily[/s] boosts NpS by at least [s]300%[/s]. Also, boosts [s]morale[/s].",        Star:4,      Type:"Food"                                              },
        3022: {File:"goldenCrab",                   Name:"Golden Crab",                 Lore:"Exceptional food that [s]temporarily[/s] boosts NpS by at least [s]300%[/s]. Also, boosts [s]morale[/s].",        Star:4,      Type:"Food"                                       },
        3023: {File:"jadeParcels",                  Name:"Jade Parcels",                Lore:"Exceptional food that [s]temporarily[/s] boosts NpS by at least [s]300%[/s]. Also, boosts [s]morale[/s].",        Star:4,      Type:"Food"                                     },
        3024: {File:"meatLoversMushroomPizza",      Name:"Meat Lovers Mushroom Pizza",  Lore:"Exceptional food that [s]temporarily[/s] boosts NpS by at least [s]300%[/s]. Also, boosts [s]morale[/s].",        Star:4,      Type:"Food"           },
        3025: {File:"sashimiPlatter",               Name:"Sashimi Platter",             Lore:"Exceptional food that [s]temporarily[/s] boosts NpS by at least [s]300%[/s]. Also, boosts [s]morale[/s].",        Star:4,      Type:"Food"                               },
        3026: {File:"tandooriRoastChicken",         Name:"Tandoori Roast Chicken",      Lore:"Exceptional food that [s]temporarily[/s] boosts NpS by at least [s]300%[/s]. Also, boosts [s]morale[/s].",        Star:4,      Type:"Food"                  },
    
        3041: {File:"comeandGetIt",                 Name:"Come and Get It",             Lore:"Premium food that [s]temporarily[/s] boosts NpS by at least [s]200%[/s]. Also, boosts [s]morale[/s].",        Star:3,      Type:"Food"                                 },
        3042: {File:"curedPorkDryHotpot",           Name:"Cured Pork Dry Hotpot",       Lore:"Premium food that [s]temporarily[/s] boosts NpS by at least [s]200%[/s]. Also, boosts [s]morale[/s].",        Star:3,      Type:"Food"                     },
        3043: {File:"barbatosRatatouille",          Name:"Barbatos Ratatouille",        Lore:"Premium food that [s]temporarily[/s] boosts NpS by at least [s]200%[/s]. Also, boosts [s]morale[/s].",        Star:3,      Type:"Food"                     },
        3044: {File:"baklava",                      Name:"Baklava",                     Lore:"Premium food that [s]temporarily[/s] boosts NpS by at least [s]200%[/s]. Also, boosts [s]morale[/s].",        Star:3,      Type:"Food"                                              },
        3045: {File:"butterChicken",                Name:"Butter Chicken",              Lore:"Premium food that [s]temporarily[/s] boosts NpS by at least [s]200%[/s]. Also, boosts [s]morale[/s].",        Star:3,      Type:"Food"                                 },
        3046: {File:"dragonBeardNoodles",           Name:"Dragon Beard Noodles",        Lore:"Premium food that [s]temporarily[/s] boosts NpS by at least [s]200%[/s]. Also, boosts [s]morale[/s].",        Star:3,      Type:"Food"                      },
        3047: {File:"goldenChickenBurger",          Name:"Golden Chicken Burger",       Lore:"Premium food that [s]temporarily[/s] boosts NpS by at least [s]200%[/s]. Also, boosts [s]morale[/s].",        Star:3,      Type:"Food"                    },
        3048: {File:"goldenShrimpBalls",            Name:"Golden Shrimp Balls",         Lore:"Premium food that [s]temporarily[/s] boosts NpS by at least [s]200%[/s]. Also, boosts [s]morale[/s].",        Star:3,      Type:"Food"                        },
    
        3061: {File:"masalaCheese",                 Name:"Masala Cheese Balls",         Lore:"Good food that [s]temporarily[/s] boosts NpS by at least [s]100%[/s]. Also, boosts [s]morale[/s].",        Star:2,      Type:"Food"                             },
        3062: {File:"jueyunChili",                  Name:"Jueyun Chili Chicken",        Lore:"Good food that [s]temporarily[/s] boosts NpS by at least [s]100%[/s]. Also, boosts [s]morale[/s].",        Star:2,      Type:"Food"                             },
        3063: {File:"katsuSandwich",                Name:"Katsu Sandwich",              Lore:"Good food that [s]temporarily[/s] boosts NpS by at least [s]100%[/s]. Also, boosts [s]morale[/s].",        Star:2,      Type:"Food"                                 },
        3064: {File:"crabRoeKourayaki",             Name:"Crab Roe Kourayaki",          Lore:"Good food that [s]temporarily[/s] boosts NpS by at least [s]100%[/s]. Also, boosts [s]morale[/s].",        Star:2,      Type:"Food"                          },
        3065: {File:"dangoMilk",                    Name:"Dango Milk",                  Lore:"Good food that [s]temporarily[/s] boosts NpS by at least [s]100%[/s]. Also, boosts [s]morale[/s].",        Star:2,      Type:"Food"                                         },
        3066: {File:"curryShrimp",                  Name:"Curry Shrimp",                Lore:"Good food that [s]temporarily[/s] boosts NpS by at least [s]100%[/s]. Also, boosts [s]morale[/s].",        Star:2,      Type:"Food"                                     },
        3067: {File:"fishermanToast",               Name:"Fisherman's Toast",           Lore:"Good food that [s]temporarily[/s] boosts NpS by at least [s]100%[/s]. Also, boosts [s]morale[/s].",        Star:2,      Type:"Food"                             },
        3068: {File:"roseCustard",                  Name:"Rose Custard",                Lore:"Good food that [s]temporarily[/s] boosts NpS by at least [s]100%[/s]. Also, boosts [s]morale[/s].",        Star:2,      Type:"Food"                                     },
        3069: {File:"sweetMadame",                  Name:"Sweet Madame",                Lore:"Good food that [s]temporarily[/s] boosts NpS by at least [s]100%[/s]. Also, boosts [s]morale[/s].",        Star:2,      Type:"Food"                                     },
        3070: {File:"jewelrySoup",                  Name:"Jewelry Soup",                Lore:"Good food that [s]temporarily[/s] boosts NpS by at least [s]100%[/s]. Also, boosts [s]morale[/s].",        Star:2,      Type:"Food"                                     },
       
        3081: {Name:"Chicken Mushroom Skewer",      File:"chickenMushroomSkewer",       Lore:"Decent food that [s]temporarily[/s] boosts NpS by at least [s]30%[/s]. Also, boosts [s]morale[/s].",        Star:1 ,      Type:"Food"                       },
        3082: {Name:"Egg Roll",                     File:"eggRoll",                     Lore:"Decent food that [s]temporarily[/s] boosts NpS by at least [s]30%[/s]. Also, boosts [s]morale[/s].",        Star:1 ,      Type:"Food"                                    },
        3083: {Name:"Lambad Fish Roll",             File:"lambadFishRoll",              Lore:"Decent food that [s]temporarily[/s] boosts NpS by at least [s]30%[/s]. Also, boosts [s]morale[/s].",        Star:1 ,      Type:"Food"                             },
        3084: {Name:"Mint Jelly",                   File:"mintJelly",                   Lore:"Decent food that [s]temporarily[/s] boosts NpS by at least [s]30%[/s]. Also, boosts [s]morale[/s].",        Star:1 ,      Type:"Food"                                  },
        3085: {Name:"Minty Bean Soup",              File:"mintyBeanSoup",               Lore:"Decent food that [s]temporarily[/s] boosts NpS by at least [s]30%[/s]. Also, boosts [s]morale[/s].",        Star:1 ,      Type:"Food"                              },
        3086: {Name:"Miso Soup",                    File:"misoSoup",                    Lore:"Decent food that [s]temporarily[/s] boosts NpS by at least [s]30%[/s]. Also, boosts [s]morale[/s].",        Star:1 ,      Type:"Food"                                   },
        3087: {Name:"Mora Meat",                    File:"moraMeat",                    Lore:"Decent food that [s]temporarily[/s] boosts NpS by at least [s]30%[/s]. Also, boosts [s]morale[/s].",        Star:1 ,      Type:"Food"                                   },
        3088: {Name:"Steak",                        File:"steak",                       Lore:"Decent food that [s]temporarily[/s] boosts NpS by at least [s]30%[/s]. Also, boosts [s]morale[/s].",        Star:1 ,      Type:"Food"                                      },
        3089: {Name:"Sweet Shrimp Sushi",           File:"sweetShrimpSushi",            Lore:"Decent food that [s]temporarily[/s] boosts NpS by at least [s]30%[/s]. Also, boosts [s]morale[/s].",        Star:1 ,      Type:"Food"                           },
        3090: {Name:"Teyvat Fried Egg",             File:"teyvatFriedEgg",              Lore:"Decent food that [s]temporarily[/s] boosts NpS by at least [s]30%[/s]. Also, boosts [s]morale[/s].",        Star:1 ,      Type:"Food"                             },
