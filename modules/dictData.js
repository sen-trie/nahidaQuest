...
const sceneInfo = {
    "1-A":{Type:"LuckCheck"               ,Lore:"You encountered the [s]Dreadful Withering[/s] as you were exploring."},
    ...
    "2-A":{Type:"LuckCheck"               ,Lore:"You encountered the [s]Dreadful Withering[/s] as you were exploring."},
    "2-A":{Type:"LuckCheckFail"           ,Lore:"Oh no! The mobs were too overwhelming so you were forced to run away."},
    "2-A":{Type:"LuckCheckSuccess"        ,Lore:"You were successful in clearing the decay!"},
    "3-A":{Type:"Exploration"             ,Lore:""},
    "4-A":{Type:"Meeting"                 ,Lore:""},
    "5-A":{Type:"Meeting"                 ,Lore:""},
    ...
    "11-A":{Type:"LuckCheckFail"          ,Lore:"A [s]Wenut[/s] was hiding underneath! You were attacked by its unexpected charge."},
    "11-A":{Type:"LuckCheckSuccess"       ,Lore:"A [s]Wenut[/s] was hiding underneath! You managed to get away in time."},
    ...
    "17-A":{Type:"Exploration"            ,Lore:"You came across a strange [s]Aranara[/s] that was medidating underneath a waterfall. As a wise forest spirit, it imparts counsel to those who seek it. After listening to its advice, you feel invigorated."},
    "18-A":{Type:"Exploration"            ,Lore:""},
    "19-A":{Type:"Meeting"                ,Lore:""},
    "20-A":{Type:"Trade"                  ,Lore:""},
    "21-A":{Type:"Meeting"                ,Lore:""},
    "22-A":{Type:"Trade"                  ,Lore:"Dori, the elusive merchant, approaches you with what she calls a [s]'fantastic, unbeatable, unmatched, mind-blowing, once-in-a-lifetime deal'[/s]."},
}
