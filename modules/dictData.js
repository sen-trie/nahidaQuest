...
const imgKey = {
    ...
    24:{Left:"55",  Top:"21",   Level:12,   Wave:["15_B","20_A"]},
    25:{Left:"66",  Top:"40",   Level:12,   Wave:["16_A","19_A"]},
}
...
const advInfo = {
    ...
    4:{Item:[1312,2059,5020,5022], Desc:"Successful expeditions have a chance to reward [s]an additional item[/s]. <br><br><br><br> Battle Stats are also increased <br><br> [hp]"},
    5:{Item:[1306,5023,5019,5021], Desc:"Unlock [s]Skill Attack[/s]. <br><br><br><br> Enemies can be marked with [s]`Seeds of Skandha`[/s], dealing additional DMG and provides healing upon [s]Parry Attack[/s]."},
    ...
    8:{Item:[1210,2038,5013,5015], Desc:"Defeating enemies immediately [s]regenerates[/s] a bars of [s]HP[/s]. <br><br><br><br> Battle Stats are also increased <br><br> [hp]"},
    9:{Item:[1202,2039,5016,5012,5014], Desc:"An additional [s]Parry Attack[/s] can be stored."},
    10:{Item:[1206,2031,4012,4001], Desc:"Unlock [s]Burst Attack[/s]. <br><br><br><br> Reset all enemies' attacks while dealing immense damage."},
    11:{Item:[1104,2001,5002,4010], Desc:"Bounty rewards provide 15% more [s]XP[/s] and [s]Primogems[/s]."},
    12:{Item:[1107,2004,5003,5004], Desc:"Successful expeditions have a higher chance to reward [s]an additional item[/s]. <br><br><br><br> Battle Stats are also increased <br><br> [hp]"},
    ...
    16:{Item:[1008,1020,4013,6001,6002], Desc:"Increase the charge rate of [s]Parry Attack[/s] by 10%. <br><br><br><br> Battle Stats are also increased <br><br> [hp]"},
    ...
    20:{Item:[1015,1019,5001,4010,4001], Desc:"Once per battle, survive a [s]lethal blow[/s]. <br><br><br><br> Battle Stats are also increased <br><br> [hp]"},
}
