...
const sceneInfo = {
    ...
    "1-A":{Type:"LuckCheckFail"           ,Lore:"Oh no! The decay was too overwhelming so you were forced to escape."},
    "1-A":{Type:"LuckCheckSuccess"        ,Lore:"You were successful in clearing the decay!"},
    ...
    "2-A":{Type:"LuckCheckFail"           ,Lore:"Oh no! The fungi were too overwhelming so you were forced to run away."},
    "2-A":{Type:"LuckCheckSuccess"        ,Lore:"You were successful in clearing the decay!"},
    ...
    "6-A":{Type:"Trade"                   ,Lore:"The Academiya is willing to provide resources in exchange of [s]Primogems[/s]"},
    "7-A":{Type:"Treasure"                ,Lore:""},
    "8-A":{Type:"Meeting"                 ,Lore:""},
    "9-A":{Type:"Trade"                   ,Lore:"You came across a caravan that are willing to "},
    ...
    "11-A":{Type:"LuckCheck"              ,Lore:"There's appears to be something [s]shining[/s] underneath the sand. Maybe there's hidden [s]treasure[/s]?"},
    ...
    "21-A":{Type:"Meeting"                ,Lore:""},
    "22-A":{Type:"Trade"                  ,Lore:"Dori, the elusive merchant, approaches you with what she calls a [s]'fantastic, unbeatable, unmatched, mind-blowing, once-in-a-lifetime deal'[/s]. Will you accept the deal?"},
}
...
const InventoryDefault = {
    // 6 STAR WEAPON
        ...
        1019: {File:"beaconReedSea",           Name:"Beacon of the Reed Sea",            Lore:"An unstoppable weapon that increases power of [s]Claymore[/s] characters by at least [s]360%[/s].  \n \n (Only characters currently purchased count.)",      Star:6,  Type:"Claymore" ,         },
        1020: {File:"lightFoliar",             Name:"Light of Foliar Incision",          Lore:"An unstoppable weapon that increases power of [s]Sword[/s] characters by at least [s]360%[/s].  \n \n (Only characters currently purchased count.)",      Star:6,  Type:"Sword"    ,           },
        // 5 STAR
