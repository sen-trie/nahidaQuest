...
let enemyInfo = {
    ...
    quicktimeDict: {
        3:{
            1:[0.34,0.38],
            2:[0.35,0.38,0.36],
            3:[0.34,0.38,0.40,0.33],
        },
        4:{
            1:[0.42,0.34,0.42,0.36,0.47],
            2:[0.45,0.32,0.42,0.50],
            3:[0.41,0.42,0.41],
            4:[0.48,0.48],
        },
        5:{
            1:[0.49,0.53],
            2:[0.41,0.51,0.51,0.41],
            3:[0.46,0.35,0.41,0.53],
            4:[0.46,0.52,0.46],
            5:[0.32,0.37,0.43,0.49,0.55],
        }
    },
    ...
    111:{Class:"Mob",       Variation:4,   Type:"Hilichurl",   HP:100,   ATK:0.5,   AtkCooldownLower:40,   AtkCooldownUpper:45},
    112:{Class:"Leader",    Variation:3,   Type:"Hilichurl",   HP:140,   ATK:1,     AtkCooldownLower:45,   AtkCooldownUpper:50},
    121:{Class:"Mob",       Variation:5,   Type:"Specter",     HP:200,   ATK:1,     AtkCooldownLower:50,   AtkCooldownUpper:50},
    131:{Class:"Mob",       Variation:4,   Type:"Hoarder",     HP:100,   ATK:1,     AtkCooldownLower:40,   AtkCooldownUpper:45},
    // LVL 2
    ...
    202:{Class:"Leader",    Variation:3,   Type:"Eremite",     HP:250,   ATK:1.5,   AtkCooldownLower:25,   AtkCooldownUpper:30},
    ...
    222:{Class:"Leader",    Variation:2,   Type:"Automaton",   HP:300,   ATK:1.5,   AtkCooldownLower:25,   AtkCooldownUpper:30},
    ...
    311:{Class:"Mob",       Variation:5,   Type:"Fatui",       HP:200,   ATK:2,     AtkCooldownLower:50,   AtkCooldownUpper:50},
    312:{Class:"Leader",    Variation:4,   Type:"Fatui",       HP:300,   ATK:3,     AtkCooldownLower:30,   AtkCooldownUpper:30},
    321:{Class:"Mob",       Variation:4,   Type:"Hilichurl",   HP:200,   ATK:2,     AtkCooldownLower:50,   AtkCooldownUpper:50},
    322:{Class:"Leader",    Variation:3,   Type:"Hilichurl",   HP:350,   ATK:3,     AtkCooldownLower:40,   AtkCooldownUpper:40},
    331:{Class:"Leader",    Variation:4,   Type:"MAbyss",      HP:400,   ATK:2,     AtkCooldownLower:25,   AtkCooldownUpper:30},
    // LVL 4
    ...
    412:{Class:"Boss",      Variation:2,   Type:"Hilichurl",   HP:1000,   ATK:3,    AtkCooldownLower:25,   AtkCooldownUpper:30},
    421:{Class:"Superboss", Variation:1,   Type:"Fatui",       HP:2666,   ATK:4,    AtkCooldownLower:50,   AtkCooldownUpper:50},
    431:{Class:"Superboss", Variation:2,   Type:"Automaton",   HP:2700,   ATK:4,    AtkCooldownLower:50,   AtkCooldownUpper:50},
    // LVL 5
    ...
    501:{Class:"Mob",       Variation:2,   Type:"WAbyss",      HP:700,   ATK:1.5,   AtkCooldownLower:50,   AtkCooldownUpper:50},
    502:{Class:"Leader",    Variation:2,   Type:"WAbyss",      HP:1100,   ATK:2,     AtkCooldownLower:50,   AtkCooldownUpper:50},
    503:{Class:"Boss",      Variation:1,   Type:"WAbyss",      HP:1700,   ATK:4,     AtkCooldownLower:50,   AtkCooldownUpper:50},
    504:{Class:"Superboss", Variation:1,   Type:"WAbyss",      HP:3000,   ATK:4,     AtkCooldownLower:50,   AtkCooldownUpper:50},
    511:{Class:"Mob",       Variation:3,   Type:"HAbyss",      HP:750,   ATK:1.5,   AtkCooldownLower:50,   AtkCooldownUpper:50},
    512:{Class:"Leader",    Variation:3,   Type:"HAbyss",      HP:1300,   ATK:2,     AtkCooldownLower:50,   AtkCooldownUpper:50},
    521:{Class:"Mob",       Variation:3,   Type:"Automaton",   HP:800,   ATK:1.5,   AtkCooldownLower:50,   AtkCooldownUpper:50},
    522:{Class:"Leader",    Variation:3,   Type:"Automaton",   HP:1200,   ATK:2,     AtkCooldownLower:50,   AtkCooldownUpper:50},
    523:{Class:"Boss",      Variation:1,   Type:"Automaton",   HP:2000,   ATK:2.5,   AtkCooldownLower:50,   AtkCooldownUpper:50},
    531:{Class:"Leader",    Variation:3,   Type:"Eremite",     HP:750,   ATK:1.5,   AtkCooldownLower:50,   AtkCooldownUpper:50},
    532:{Class:"Boss",      Variation:2,   Type:"Eremite",     HP:1200,   ATK:2,     AtkCooldownLower:50,   AtkCooldownUpper:50},
}
