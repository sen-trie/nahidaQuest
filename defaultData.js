...
let advDictDefault = {
    ...
    bountyTime: 0,
    rankDict: {
        1:{Locked:false,    Desc:"Unlock Parry Attack"},
        2:{Locked:true,     Desc:"Begin fights with Parry Attack charged"},
        3:{Locked:true,     Desc:"Reduce the ambush rate from enemies"},
        4:{Locked:true,     Desc:"Successful expeditions reward more items"},
        5:{Locked:true,     Desc:"Unlock Skill Attack"},
        6:{Locked:true,     Desc:"Party has a 5% chance to evade enemy attacks"},
        7:{Locked:true,     Desc:"Skill Attack has a 40% chance to end its cooldown (Can only occur every 10s)"},
        8:{Locked:true,     Desc:"Defeating enemies immediately regenerates 5% of HP"},
        9:{Locked:true,     Desc:"Nullify ambushes from enemies"},
        10:{Locked:true,    Desc:"Unlock Burst Attack"},
        11:{Locked:true,    Desc:"Increase the chance of getting a preemptive strike on foes"},
        12:{Locked:true,    Desc:"Successful expeditions reward even more items"},
        13:{Locked:true,    Desc:"Evasion rate is increased to 10%"},
        14:{Locked:true,    Desc:"Skill Attack has a 70% chance to end its cooldown (Can only occur every 10s)"},
        15:{Locked:true,    Desc:"Burst Attack regenerate 5% of HP"},
        16:{Locked:true,    Desc:"Increase the charge rate of Burst Attack by 10%."},
        17:{Locked:true,    Desc:"Increase the chance of getting a preemptive strike on foes even further"},
        18:{Locked:true,    Desc:"An additional Burst Attack can be stored"},
        19:{Locked:true,    Desc:"Evasion rate is further increased to 15%"},
        20:{Locked:true,    Desc:"Once per battle, survive a lethal blow with 1 HP"},
    }
}
